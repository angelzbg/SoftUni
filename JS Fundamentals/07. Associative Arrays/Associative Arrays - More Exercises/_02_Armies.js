armies = (arr = []) => {
    ...
    arr.forEach((line) => {
        let format = line.includes('arrives') ? 1 : line.includes(':') ? 2 : line.includes('+') ? 3 : 4;
        ...
        if (format === 1) {
            ...
            // Add army and count to leader (if exists)
            ...
            // 4 - delete the leader and his army (if he exists)
